function ordered_functions = order_pp_functions()
pp_config
...
fcts_map = update_fcts(fcts_map, pp_order_map);
fcts_map = extract_fcts(fcts_map, pp_handled_blocks, lowest_priority);
fcts_map = extract_fcts(fcts_map, pp_unhandled_blocks, -1);
...
function ordered_fcts_map = update_fcts(ordered_fcts_map, pp_order_map)
