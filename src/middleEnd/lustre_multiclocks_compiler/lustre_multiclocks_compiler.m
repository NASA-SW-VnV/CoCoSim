function [nom_lustre_file, xml_trace]=lustre_multiclocks_compiler(model_path, const_files, mode_display)
...
[main_node, external_nodes] = block_to_lustre(main_block, main_sampleTime, xml_trace);
lustre_code  = sprintf('%s\n---Main Node\n%s',external_nodes, main_node);
