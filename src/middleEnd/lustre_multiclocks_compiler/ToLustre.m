...
recursiveGeneration(main_block, main_sampleTime, xml_trace, fid);
...
%%
function recursiveGeneration(blk, main_sampleTime, xml_trace, fid)
if isfield(blk, 'Content')
    field_names = fieldnames(blk.Content);
    for i=1:numel(field_names)
        recursiveGeneration(blk.Content.field_names{i}, main_sampleTime, xml_trace, fid);
    end
    [main_node, external_nodes] = subsys2str(blk, main_sampleTime, xml_trace);
    fprintf(fid, '%s\n%s', external_nodes, main_node);
end
end
