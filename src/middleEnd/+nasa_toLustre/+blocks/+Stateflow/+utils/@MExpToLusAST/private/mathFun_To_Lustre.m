function [code, exp_dt] = mathFun_To_Lustre(BlkObj, tree, parent, blk,...
    ...
    switch tree_ID
        ...
        case {'atan2', 'power', 'pow'}
            ...
            [param1, ~] = nasa_toLustre.blocks.Stateflow.utils.MExpToLusAST.expression_To_Lustre(BlkObj, tree.parameters(1),...
                parent, blk, data_map, inputs, 'real', ...
                isSimulink, isStateFlow, isMatlabFun);
            [param2, ~] = nasa_toLustre.blocks.Stateflow.utils.MExpToLusAST.expression_To_Lustre(BlkObj, tree.parameters(2),...
                parent, blk, data_map, inputs, 'real', ...
                isSimulink, isStateFlow, isMatlabFun);
        ...
        case {'rem', 'mod'}
            [param1, param1_dt] = nasa_toLustre.blocks.Stateflow.utils.MExpToLusAST.expression_To_Lustre(BlkObj, tree.parameters(1),...
                parent, blk, data_map, inputs, '', ...
                isSimulink, isStateFlow, isMatlabFun);
            [param2, param2_dt] = nasa_toLustre.blocks.Stateflow.utils.MExpToLusAST.expression_To_Lustre(BlkObj, tree.parameters(2),...
                parent, blk, data_map, inputs, '', ...
                isSimulink, isStateFlow, isMatlabFun);
