function [code, exp_dt, dim] = transpose_To_Lustre(BlkObj, tree, parent, blk,...
    ...
    [x, exp_dt, x_dim] = nasa_toLustre.blocks.Stateflow.utils.MExpToLusAST.expression_To_Lustre(BlkObj, tree.leftExp,...
