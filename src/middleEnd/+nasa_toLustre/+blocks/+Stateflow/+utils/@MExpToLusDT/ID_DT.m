function [lusDT, slxDT] = ID_DT(tree, args)
    ...
    elseif isSimulink && strcmp(id, 'u')
        ...
        [lusDT, slxDT] = nasa_toLustre.blocks.Stateflow.utils.MExpToLusDT.getVarDT(data_map, inputs{1}{1}.getId());
    ...
    elseif isSimulink && ~isempty(regexp(id, 'u\d+', 'match'))
        ...
        [lusDT, slxDT] = nasa_toLustre.blocks.Stateflow.utils.MExpToLusDT.getVarDT(data_map, id);
    end
end
