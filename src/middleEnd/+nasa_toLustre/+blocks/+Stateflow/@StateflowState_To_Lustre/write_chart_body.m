            ...
            if isequal(d.Scope, 'Output')
                ...
                if ismember(d_name, nodeCall_inputs_Names)
                    body{end+1} = nasa_toLustre.lustreAst.LustreEq(...
                        ...
                        nasa_toLustre.lustreAst.UnaryExpr(UnaryExpr.PRE, nasa_toLustre.lustreAst.VarIdExpr(d_name))));
            ...
            elseif isequal(d.Scope, 'Local')
                ...
                if ismember(d_name, nodeCall_outputs_Names)
                    body{end+1} = nasa_toLustre.lustreAst.LustreEq(...
                        ...
                        nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.ARROW, IC_Var, ...
                        nasa_toLustre.lustreAst.UnaryExpr(UnaryExpr.PRE, nasa_toLustre.lustreAst.VarIdExpr(d_lastName))));
            ...
            if MatlabUtils.endsWith(v_name, ...
                ...
                if ismember(v_name, nodeCall_outputs_Names)
                    ...
                    body{end+1} = nasa_toLustre.lustreAst.LustreEq(...
                        ...
                        nasa_toLustre.lustreAst.UnaryExpr(UnaryExpr.PRE, nasa_toLustre.lustreAst.VarIdExpr(v_lastName))));
