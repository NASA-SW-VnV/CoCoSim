...
classdef StateflowTransition_To_Lustre
    ...
    methods(Static)
        ...
        [transitionNode, external_nodes, external_libraries] = ...
        ...
        [body, outputs, inputs, variables, external_libraries, ...
                ...
                transitions_code(transitions, data_map, isDefaultTrans, ...
                isFlowChartJunction, parentPath, ...
                validDestination_cond, Termination_cond, cond_prefix,...
                fullPathT, variables)
