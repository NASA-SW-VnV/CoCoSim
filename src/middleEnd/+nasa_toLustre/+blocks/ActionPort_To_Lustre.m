classdef ActionPort_To_Lustre < nasa_toLustre.frontEnd.Block_To_Lustre
    %ActionPort_To_Lustre is supported by SubSystem_To_Lustre. Here we add only not
    %supported options    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        ...
        function options = getUnsupportedOptions(obj, ~, blk, lus_backend, varargin)
            if LusBackendType.isJKIND(lus_backend) ...
                    && strcmp(blk.InitializeStates, 'reset')
