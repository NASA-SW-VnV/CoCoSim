    ...
    methods
        ...
        function options = getUnsupportedOptions(obj,parent, blk, varargin)
            ...
            for i = 1 : length(SFContent.Data)
                d = SFContent.Data{i};
                if coco_nasa_utils.MatlabUtils.contains(d.Datatype, 'Enum:') ...
                        || coco_nasa_utils.MatlabUtils.contains(d.Datatype, 'Bus:')...
                        || coco_nasa_utils.MatlabUtils.contains(d.Datatype, 'fixdt')
                    obj.addUnsupported_options(...
