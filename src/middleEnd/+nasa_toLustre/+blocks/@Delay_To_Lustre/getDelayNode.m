function [delay_node] = getDelayNode(node_name, ...
    ...
    pre_u_thens = {};
    if isDelayVariable
        pre_u_conds{end + 1} = nasa_toLustre.lustreAst.BinaryExpr(BinaryExpr.LT, ...
        ...
        pre_u_conds{end + 1} = nasa_toLustre.lustreAst.BinaryExpr(BinaryExpr.GT, ...
    ...
    for i=1:delayLength
        ...
        if isReset
            ...
            enable_then = nasa_toLustre.lustreAst.UnaryExpr(UnaryExpr.PRE, ...
                nasa_toLustre.lustreAst.VarIdExpr(pre_u_i_plus_1));
        end
        if isEnabel
        ...
        if isDelayVariable
            j = delayLength - i + 1;
            pre_u_conds{end + 1} = nasa_toLustre.lustreAst.BinaryExpr(BinaryExpr.EQ, ...
