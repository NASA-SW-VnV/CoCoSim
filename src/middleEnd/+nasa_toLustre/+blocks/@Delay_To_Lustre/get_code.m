function [lustre_code, delay_node_code, variables, external_libraries] = ...
    ...
    if isEnabe
        ...
        enableCondition = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GT, ...
        ...
        for i=1:numel(u)
            ...
            codes{end + 1} = nasa_toLustre.lustreAst.LustreEq(lhs, ...
                ...
                nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.ARROW, ...
                            x0{i}, ...
                            nasa_toLustre.lustreAst.UnaryExpr(nasa_toLustre.lustreAst.UnaryExpr.PRE, nasa_toLustre.lustreAst.VarIdExpr(varName)))));
            %codes{end + 1} = sprintf(...
            %    '%s = if  %s then %s\n\t\t\t', ...
