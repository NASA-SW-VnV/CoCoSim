function extNode =  get_wrapper_node(...
    ...
    % breakpoint
    index_node = cell(1,numAdjDims); 
    corrected_bound_node_subscript = cell(1,2*numAdjDims); 
    node_subscript_name = cell(numAdjDims,2);
    ...
    for i=1:numAdjDims
        ...
        node_subscript_name{i,1} = ...
            nasa_toLustre.lustreAst.VarIdExpr(sprintf(...
            'bound_node1_sub_%d',i));
        node_subscript_name{i,2} = ...
            nasa_toLustre.lustreAst.VarIdExpr(sprintf(...
            'bound_node2_sub_%d',i)); 
        vars{(i-1)*2+1} = nasa_toLustre.lustreAst.LustreVar(...
                node_subscript_name{i,1},'int');
        vars{(i-1)*2+2} = nasa_toLustre.lustreAst.LustreVar(...
                node_subscript_name{i,2},'int');             
        ...
        corrected_bound_node_subscript{i,1} = index_node{i,1};
        corrected_bound_node_subscript{i,2} = index_node{i,2};
        body{(i-1)*2+1} = nasa_toLustre.lustreAst.LustreEq(...
                node_subscript_name{i,1},...
                corrected_bound_node_subscript{i,1});
        body{(i-1)*2+2} = nasa_toLustre.lustreAst.LustreEq(...
                node_subscript_name{i,2},...
                corrected_bound_node_subscript{i,2});            
    end
    body_all = [body_all  body];
    vars_all = [vars_all  vars];    
    ...
    [body, vars, bounding_nodes] = ...
        ...
        node_subscript_name,Ast_dimJump,blkParams);
    body_all = [body_all  body];
    vars_all = [vars_all  vars];
