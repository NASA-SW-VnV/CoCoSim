function contractBody = getContractBody(blkParams,inputs,outputs)
    ...
    if blkParams.yIsBounded
        ...
        for i=1:numel(inputs)
            counter = counter + 1;
            terms{counter} = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                    inputs{i}{1},...
                                    nasa_toLustre.lustreAst.RealExpr(min(blkParams.BreakpointsForDimension{i})));
            counter = counter + 1;
            terms{counter} = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.LTE, ...
                                    inputs{i}{1},...
                                    nasa_toLustre.lustreAst.RealExpr(max(blkParams.BreakpointsForDimension{i})));
        ...
        P = nasa_toLustre.lustreAst.BinaryExpr.BinaryMultiArgs(nasa_toLustre.lustreAst.BinaryExpr.AND,terms);
        %Q = sprintf('%s >= %.15f and  %s <= %.15f', outputs{1},blkParams.tableMin, outputs{1},blkParams.tableMax);
        Q = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.AND,...
                       nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                  outputs{1},...
                                  nasa_toLustre.lustreAst.RealExpr(blkParams.tableMin)),...
                       nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.LTE, ...
                                  ...
                                  nasa_toLustre.lustreAst.RealExpr(blkParams.tableMax)));
        contractBody{end+1} = nasa_toLustre.lustreAst.ContractGuaranteeExpr('', ...
            nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.IMPLIES,...
                       P,...
                       Q));
    ...
    if blkParams.NumberOfTableDimensions == 1
        for i=1:numel(blkParams.BreakpointsForDimension{1})-1
            ...
            P = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.AND,...
                           nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                  inputs{1},...
                                  nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{1}(i))),...
                           nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.LTE, ...
                                  inputs{1},...
                                  nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{1}(i+1))));
            Q = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.AND,...
                           nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                  outputs{1},...
    ...
    elseif blkParams.NumberOfTableDimensions == 2
        for i=1:numel(blkParams.BreakpointsForDimension{1})-1
            for j=1:numel(blkParams.BreakpointsForDimension{2})-1
                ...
                P1_1 = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                  inputs{1}{1},...
                                  nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{1}(i)));   % dim 1 lower
                P1_2 =   nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.LTE, ...
                                    inputs{1}{1},...
                                    nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{1}(i+1)));   % dim 1 upper                 
                P2_1 = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                  inputs{2}{1},...
                                  nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{2}(j))); % dim 2 lower
                P2_2 = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.LTE, ...
                                  inputs{2}{1},...
                                  nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{2}(j+1)));   %dim 2 upper                      
                ...
                P = nasa_toLustre.lustreAst.BinaryExpr.BinaryMultiArgs(nasa_toLustre.lustreAst.BinaryExpr.AND,{P1_1, P1_2, P2_1, P2_2});
                Q = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.AND,...
                               nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                      outputs{1},...
                                      nasa_toLustre.lustreAst.RealExpr(min(curTable))),...
            ...
            for j=1:numel(blkParams.BreakpointsForDimension{2})-1
                for k=1:numel(blkParams.BreakpointsForDimension{3})-1
                    ...
                    P2_2 = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.LTE, ...
                        inputs{2}{1},...
                        nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{2}(j+1)));   %dim 2 upper
                    P3_1 = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                        inputs{3}{1},...
                        nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{3}(k))); % dim 3 lower
                    P3_2 = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.LTE, ...
                        inputs{3}{1},...
                        nasa_toLustre.lustreAst.RealExpr(blkParams.BreakpointsForDimension{3}(k+1)));   %dim 3 upper                            

                    P = nasa_toLustre.lustreAst.BinaryExpr.BinaryMultiArgs(nasa_toLustre.lustreAst.BinaryExpr.AND,{P1_1, P1_2, P2_1, P2_2, P3_1, P3_2});
                    Q = nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.AND,...
                                    nasa_toLustre.lustreAst.BinaryExpr(nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                                                outputs{1},...
                                                nasa_toLustre.lustreAst.RealExpr(min(curTable))),...
