function [body, vars] = addDirectLookupNodeCode(...
    ...
    for i=1:NumberOfTableDimensions
        ...
        elseif strcmp(InterpMethod,'Nearest')
            ...
            [vars,body] = ...
                ...
                index_node,coords_node, coords_input,i, vars, body,blkParams,lus_backend,epsilon);
...
%             
%             body{end+1} = nasa_toLustre.lustreAst.LustreEq(...
%                 blkParams.sol_subs_for_dim{i}, nasa_toLustre.lustreAst.IteExpr(...
