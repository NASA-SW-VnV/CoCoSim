function [body, vars] = addDirectLookupNodeCode(blkParams,index_node,...
    coords_node,coords_input,Ast_dimJump,fraction)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    usingBreakpoints = isempty(fraction);
        ...
        if strcmp(InterpMethod,'Above')
            if usingBreakpoints
                body{end+1} = ...
                    ...
                    index_node,coords_node, coords_input,i);
            else
                body{end+1} = ...
        ...
        elseif strcmp(InterpMethod,'Nearest')
            if usingBreakpoints
                ...
                body{end+1} = ...
                    ...
                    blkParams,index_node,fraction,i,epsilon);                
            end
