...
%             lookupTableType)
        ...
        function code = get_direct_method_flat_using_fraction(blkParams,...
            ...
            maxLowerNodeIndex = tableSize(dimension) -1;  % 1 for lower node
            condition_2 =  ...
                nasa_toLustre.lustreAst.BinaryExpr(...
                nasa_toLustre.lustreAst.BinaryExpr.GTE, ...
                index_node{dimension,1},...
                nasa_toLustre.lustreAst.IntExpr(maxLowerNodeIndex));       
            condition = ...
                nasa_toLustre.lustreAst.BinaryExpr(...
                nasa_toLustre.lustreAst.BinaryExpr.AND, condition_1,...
                condition_2);
            
            code = nasa_toLustre.lustreAst.LustreEq(...                 
                blkParams.sol_subs_for_dim{dimension}, ...
                nasa_toLustre.lustreAst.IteExpr(...
                condition,index_node{dimension,2},...
                index_node{dimension,1}));                      
        end   
        ...
        function code = get_direct_method_nearest_using_fraction(blkParams,...
                index_node,fraction,dimension,epsilon)   
