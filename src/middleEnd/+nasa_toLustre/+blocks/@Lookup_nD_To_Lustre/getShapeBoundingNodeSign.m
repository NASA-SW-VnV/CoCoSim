function shapeNodeSign = getShapeBoundingNodeSign(dims)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % define the coordinate of a dimension increases from node 1 as to node
    % 2.  Linear shape function S1 is 0 and 1 at node2.  Linear shape
    ...
    % F2 = S1 and F1 = S2.  shapeNodeSign 
    % defines the inline node order of the bounding corner nodes.  For a
    % node, if the value of the shapeNodeSign for a dimension is -1, then use
    % F1 and use F2 if the shapeNodeSign for that dimension is 1.
