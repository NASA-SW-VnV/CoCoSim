...
function [main_node, external_nodes, external_libraries ] = ...
    ...
    global SF_STATES_NODESAST_MAP  ...
        SF_STATES_PATH_MAP SF_JUNCTIONS_PATH_MAP ...
        SF_MF_FUNCTIONS_MAP ...
        SF_STATES_ENUMS_MAP TOLUSTRE_ENUMS_MAP;
    ...
    for i=1:numel(junctions)
        try
            [external_nodes_i, external_libraries_i ] = ...
                nasa_toLustre.blocks.Stateflow.StateflowJunction_To_Lustre.write_OuterTransActions(junctions{i}, SF_DATA_MAP);
            external_nodes = [external_nodes, external_nodes_i];
            external_libraries = [external_libraries, external_libraries_i];
        catch me
            if strcmp(me.identifier, 'COCOSIM:STATEFLOW')
