...
function code = print(obj, backend)
    ...
    if (coco_nasa_utils.LusBackendType.isKIND2(backend) || coco_nasa_utils.LusBackendType.isPRELUDE(backend))...
    ...
    elseif ~(coco_nasa_utils.LusBackendType.isKIND2(backend) || coco_nasa_utils.LusBackendType.isJKIND(backend)) ...
            && ~isempty(obj.clock)
