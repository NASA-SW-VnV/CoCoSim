...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [code, exp_dt, dim, extra_code] = notFun_To_Lustre(tree, args)

%    
    op = nasa_toLustre.lustreAst.UnaryExpr.NOT;
    args.expected_lusDT = 'bool';
    [right, ~, dim, extra_code] = nasa_toLustre.utils.MExpToLusAST.expression_To_Lustre(tree.parameters(1), args);
