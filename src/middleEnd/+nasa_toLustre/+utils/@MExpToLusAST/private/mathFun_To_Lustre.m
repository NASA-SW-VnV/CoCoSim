function [code, exp_dt, dim] = mathFun_To_Lustre(tree, args)
    ...
    switch tree_ID
        ...
        case {'atan2', 'power', 'pow'}
            ...
            args.expected_lusDT = 'real';
            [param1, ~, dim1] = nasa_toLustre.utils.MExpToLusAST.expression_To_Lustre(...
                tree.parameters(1), args);
            [param2, ~, dim2] = nasa_toLustre.utils.MExpToLusAST.expression_To_Lustre(...
        ...
        case {'rem', 'mod'}
            args.expected_lusDT = '';
            [param1, param1_dt, dim1] = nasa_toLustre.utils.MExpToLusAST.expression_To_Lustre(tree.parameters(1), args);
            [param2, param2_dt, dim2] = nasa_toLustre.utils.MExpToLusAST.expression_To_Lustre(tree.parameters(2), args);
