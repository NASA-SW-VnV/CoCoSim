...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [code, exp_dt, dim, extra_code] = wilkinsonFun_To_Lustre(tree, args)
...
%    
    ...
    if isempty(X) || (~isa(X{1}, 'nasa_toLustre.lustreAst.IntExpr'))
        ME = MException('COCOSIM:TREE2CODE', ...
            'First argument in function wilkinson in expression "%s" should be a constant.',...
            tree.text);
        throw(ME);
    end
    
    pre_code = wilkinson(X{1}.value);
