...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    %Rounds number to the nearest representable value.
    ...
    term1 = nasa_toLustre.lustreAst.NodeCallExpr('_Floor',...
    ...
    term2 = nasa_toLustre.lustreAst.NodeCallExpr('_Ceiling',...
        nasa_toLustre.lustreAst.BinaryExpr(...
        ...
        [], [], [], 'real'));
    term3 = nasa_toLustre.lustreAst.NodeCallExpr('_Floor',...
        nasa_toLustre.lustreAst.BinaryExpr(...
        nasa_toLustre.lustreAst.BinaryExpr.DIVIDE,...
        ...
        nasa_toLustre.lustreAst.RealExpr(2), [], [], [], 'real'));
    bodyElts{1} = nasa_toLustre.lustreAst.LustreEq(...
        ...
        term1, ...
        term2, ...
        nasa_toLustre.lustreAst.UnaryExpr(nasa_toLustre.lustreAst.UnaryExpr.NEG, term3), ...
