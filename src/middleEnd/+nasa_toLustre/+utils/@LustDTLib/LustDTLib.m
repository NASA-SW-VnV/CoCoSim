classdef LustDTLib
    ...
    methods(Static)
        ...
        %% To and from Bool
        [node, external_nodes_i, opens, abstractedNodes] = getToBool(dt)
        [node, external_nodes_i, opens, abstractedNodes] = getBoolTo(dt)
        [node, external_nodes_i, opens, abstractedNodes] = get_real_to_bool(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_bool(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_bool_to_int(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_bool_to_real(varargin)
        %% Int to Int
        [node, external_nodes_i, opens, abstractedNodes] = getIntToInt(dt)
        [node, external_nodes_i, opens, abstractedNodes] = getIntToIntSaturate(dt)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_int8(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_uint8(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_int16(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_uint16(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_int32(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_uint32(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_int8_saturate(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_uint8_saturate(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_int16_saturate(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_uint16_saturate(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_int32_saturate(varargin)
        [node, external_nodes_i, opens, abstractedNodes] = get_int_to_uint32_saturate(varargin)
        %%
        [node, external_nodes_i, opens, abstractedNodes] = get_conv(lus_backend)
