...
function  [x2, y2] = process_local_assign(node_block_path, blk_exprs, var, node_name, x2, y2)
    ...
    elseif strcmp(rhs_type, 'array access')
        ...
        while(isfield(array, 'array'))
            if isfield(array, 'idx')
                ...
                elseif strcmp(array.idx.type, 'variable')
                    ...
                    idx_name = coco_nasa_utils.SLXUtils.adapt_block_name(array.idx.value, node_name);
                    nb_port_idx = nb_port_idx + 1;
                    idx_path = coco_nasa_utils.SLXUtils.makeBlockNameUnique(strcat(node_block_path,'/',ID,'_selector_idx_', num2str(nb_port_idx)));
        ...
        selector_path = coco_nasa_utils.SLXUtils.makeBlockNameUnique(strcat(node_block_path,'/',ID,'_rhs_selector'));
        ...
        rhs_name = coco_nasa_utils.SLXUtils.adapt_block_name(array.value, node_name);
        ...
        rhs_name = coco_nasa_utils.SLXUtils.adapt_block_name(blk_exprs.(var{1}).rhs.value, node_name);
        add_block('simulink/Signal Routing/From',...
            rhs_path,...
            'GotoTag',rhs_name,...
            'TagVisibility', 'local', ...
