...
if onlyMainNode
    ...
    for node = emf_fieldnames
        try
            ...
            mcdc_node_process(new_model_name, nodes, node{1}, node_block_path, mdlTraceRoot, block_pos, []);
...
if ~isempty(mcdc_variables_names)
    ...
    [x2, y2] = process_outputs(node_block_path, mcdc_variables_names, '', x2, y2);
    ...
    [x2, y2] = process_inputs(node_block_path, blk_inputs, '', x2, y2);
    ...
    instrs_process(nodes, new_model_name, node_block_path, blk_exprs, '', x2, y2, xml_trace);
