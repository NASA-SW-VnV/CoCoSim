...
%
    if mode_display
        ...
        Debugs = HtmlItem('Debug list:', ...
            ...
            'black', 'black');
        coco_nasa_utils.MenuUtils.createHtmlListUsingHTMLITEM('Log File',...
        ...
        display_msg(coco_nasa_utils.MatlabUtils.strjoin(errors_list, '\n'), MsgType.ERROR, 'ToLustre', '');
        display_msg('Warning list:', MsgType.INFO, 'ToLustre', '');
        display_msg(coco_nasa_utils.MatlabUtils.strjoin(warnings_list, '\n'), MsgType.WARNING, 'ToLustre', '');
        display_msg('Debug list:', MsgType.INFO, 'ToLustre', '');
        display_msg(coco_nasa_utils.MatlabUtils.strjoin(debug_list, '\n'), MsgType.DEBUG, 'ToLustre', '');
    end
end
