...
%       N/A
    ...
    %   1) Create the dotfile from the system or subsystem using external_lib.AutoLayout.Graphviz_Portion.dotfile_creator.
    ...
    % 1) Create the dotfile from the system or subsystem using external_lib.AutoLayout.Graphviz_Portion.dotfile_creator.
    [filename, map] = external_lib.AutoLayout.Graphviz_Portion.dotfile_creator(address);
    ...
    g = external_lib.AutoLayout.Graphviz_Portion.TplainParser(address, filename, containers.Map());
    g.plain_wrappers;
