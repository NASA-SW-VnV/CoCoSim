...
classdef CoCoDocker
    ...
    % coco_nasa_utils.CoCoDocker.start(sharedFolder)  % optionnal
    % coco_nasa_utils.CoCoDocker.exec(sharedFolder, 'lustrec -node absolute_PP -int="long long int" absolute_PP.LUSTREC.lus')
    % coco_nasa_utils.CoCoDocker.exec(sharedFolder, 'make -f absolute_PP.LUSTREC.makefile')
    % coco_nasa_utils.CoCoDocker.exec(sharedFolder, '/lus/absolute_PP.LUSTREC_absolute_PP < /lus/absolute_PP_input_values > absolute_PP_output_values')
    % coco_nasa_utils.CoCoDocker.stop()
    %% in terminal (example)
    ...
    methods(Static)
        ...
        function c_name = start(sharedFolder)
            ...
            c_name = coco_nasa_utils.CoCoDocker.getCurrentContainerName(sharedFolder);
        end
        ...
        function [errCode, stdout] = stop(sharedFolder)
            ...
            c_name = coco_nasa_utils.CoCoDocker.getCurrentContainerName(sharedFolder, true);
