...
function [status, new_name_path] = construct_EMF_verif_model(slx_file_name,...
    ...
    new_name_path = '';
    [status] = coco_nasa_utils.LustrecUtils.check_DType_and_Dimensions(slx_file_name);
    if status
        return;
    end
    tools_config;
    ...
    for i=1:nb_inports
        ...
        elseif ~isMatrix
            emf_inport_idx = ...
                coco_nasa_utils.LustrecUtils.add_demux(new_model_name, emf_inport_idx, ...
    ...
    for i=1:nb_outports
        ...
        elseif ~isMatrix
            outport_idx = coco_nasa_utils.LustrecUtils.add_mux(new_model_name, outport_idx, 2*i, num2str(i), dim,...
        ...
        elseif isMatrix
            ...
            for colon=1:dim(3)
                ...
                last_index = coco_nasa_utils.LustrecUtils.add_mux(new_model_name, outport_idx, colon, muxID, dim(2),...
