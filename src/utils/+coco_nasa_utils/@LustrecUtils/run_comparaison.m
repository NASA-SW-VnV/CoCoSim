...
function [valid,...
    ...
    if ~isa(input_dataSet, 'Simulink.SimulationData.Dataset')
        ...
        display_msg(msg, MsgType.ERROR, 'coco_nasa_utils.LustrecUtils.run_comparaison', '');
        sim_failed = 1;
        return;
    end
    ...
    err = coco_nasa_utils.LustrecUtils.compile_lustre_to_Cbinary(lus_file_path,...
    ...
    [node_struct, status] = coco_nasa_utils.LustrecUtils.extract_node_struct(lus_file_path,...
                nasa_toLustre.utils.SLX2LusUtils.name_format(node_name), ...
                LUSTREC,...
                LUCTREC_INCLUDE_DIR);
    if status
    ...
    [lustre_input_values, status] = ...
        coco_nasa_utils.LustrecUtils.getLustreInputValuesFormat(input_dataSet, time, node_struct);
    if status
        lustrec_failed = 1;
        return
    end
    ...
    status = ...
        coco_nasa_utils.LustrecUtils.printLustreInputValues(...
    ...
    try
        ...
        status = coco_nasa_utils.LustrecUtils.extract_lustre_outputs(lus_file_name,...
            output_dir, ...
            node_name,...
            input_file_name, ...
            output_file_name);
        ...
        [valid, cex_msg, diff_name, diff] = ...
            coco_nasa_utils.LustrecUtils.compare_Simu_outputs_with_Lus_outputs(...
            input_dataSet, ...
            yout,...
            outputs_array, ...
            eps, ...
