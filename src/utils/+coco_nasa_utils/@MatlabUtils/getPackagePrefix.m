...
function path_prefix = getPackagePrefix(f_parent, f_name)
    ...
    path_partsWithPlusAndAT = path_parts(coco_nasa_utils.MatlabUtils.startsWith(path_parts, '+') ...
        |coco_nasa_utils.MatlabUtils.startsWith(path_parts, '@'));
    ...
    if startsWith(path_partsWithPlusAndAT{end}, '@') ...
        ...
        path_prefix = coco_nasa_utils.MatlabUtils.strjoin(prefix_parts(1:end-1), '.');
    else
        path_prefix = coco_nasa_utils.MatlabUtils.strjoin(prefix_parts, '.');
    end
end
