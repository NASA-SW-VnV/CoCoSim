...
function [new_model_path, new_model_name, status] = ...
    ...
    CompiledPortDataTypes = coco_nasa_utils.SLXUtils.getCompiledParam(ss_path, 'CompiledPortDataTypes');
    ...
    function status = addInport(newBlkPort, portDT)
        try
            ...
            display_msg(Me.getReport(), ...
                MsgType.DEBUG, 'coco_nasa_utils.SLXUtils.createSubsystemFromBlk', '');
            status = 1;
        end
    end
