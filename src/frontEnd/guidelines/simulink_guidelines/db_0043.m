function [results, passed, priority] = db_0043(model)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     allowableFontName = ['Aerial','Helvetica'];
    ...
    description_text = [...
        'All text elements (block names, block annotations and <br>'...
        'signal labels) except free text annotations within a model <br>'...
        'must have the same font style and font size.  Fonts and <br>'...
        'font size should be selected for legibility. <br>'...
        'The selected font should be directly portable <br>'... 
        '(e.g. Simulink/Stateflow default font) or convertible  <br>'...
