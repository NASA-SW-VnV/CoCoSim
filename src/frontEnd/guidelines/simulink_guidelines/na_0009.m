function [results, passed, priority] = na_0009(model)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     end    
    ...
    description_text = [...
        'If a label is present on a signal, the following rules define <br>'...
        'whether that label shall be created there (entered directly <br>'...
        'on the signal) or propagated from its true source  <br>'...
        '(inherited from elsewhere in the model by using the "<" character).  <br>'...
        '   1.Any displayed signal label must be entered for signals that:  <br>'...
        '     a. Originate from an Inport at the Root (top) Level of a model <br>'...
        '     b. Originate from a basic block that performs a transformative operation <br>'...
        '        (For the purpose of interpreting this rule only, the Bus Creator block,  <br>'...
        '        Mux block and Selector block shall be considered to be included among  <br>'...
        '        the blocks that perform transformative operations.) <br>'...
        '   2.Any displayed signal label must be propagatedfor signals that: <br>'...
        '     a. Originate from an Inport block in a nested subsystem<br>'...
        '        Exception: If the nested subsystem is a library subsystem, a label may <br>'...
        '        be entered on the signal coming from the Inport to accommodate reuse <br>'...
        '        of the library block. <br>'...
        '     b. Originate from a basic block that performs a <br>'...
        '        non-transformative operation <br>'...
        '     c. Originate from a Subsystem or Stateflow chart block <br>'...
        '        Exception: If the connection originates from the output of a library <br>'...
        '        subsystem block instance, a new label may be entered on the signal to <br>'...
