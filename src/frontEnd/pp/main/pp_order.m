...
if exist(mat_path, 'file')
    ...
    pp_order_map(0) = {'pp2/blocks/FixedStepDiscreteSolver_pp.m',...
        'pp2/blocks/Inport_pp.m', ...
    ...
    pp_order_map(4) = {'pp2/blocks/BlocksPosition_pp.m'};
    
    
    pp_order_map(5) = {'pp2/blocks/Gain_pp.m'};

    pp_order_map(6) = {'pp2/blocks/AtomicSubsystems_pp.m'};
    pp_order_map(7) = {'pp2/blocks/ExpandNonAtomicSubsystems_pp.m'};
    
    pp_order_map(8) = {'pp2/blocks/AlgebraicLoops_pp.m'};
    
    pp_order_map(9) = {'pp2/blocks/CompileModelCheck_pp.m'};
