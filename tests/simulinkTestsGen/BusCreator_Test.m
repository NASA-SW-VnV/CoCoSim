classdef BusCreator_Test < Block_Test
    %BusCreator_Test generates test automatically.
    
    properties(Constant)
        fileNamePrefix = 'BusCreator_TestGen';
        blkLibPath = 'simulink/Signal Routing/Bus Creator';
    end
    ...
    properties
        ...
        OutDataTypeStr = {'Inherit: auto','double','single',...
            'int8','uint8','int16','uint16','int32',...
            'uint32','int64','uint64','boolean',...
            'Enum: <class name>','Bus: <object name>'};
    end
    
    properties
        % other properties
        InheritFromInputs = {'on','off'};
        DisplayOption = {'none','signals','bar'};
        NonVirtualBus = {'on','off'};
    end
